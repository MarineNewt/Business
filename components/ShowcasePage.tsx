...
import showcaseimg2 from '@/public/images/showcase/showcase-emblem.png';
    ...
    <div className={styles.fullpagesolid}>
      ...
      <div className={styles.showcasecontainer}>
        <div className={styles.showcaseouter}>
          <a className={styles.showcaseblock1} style={{backgroundImage: `url(${showcaseimg1.src})`}} href="https://www.introme.me/intro/newt" target="_blank" rel="noopener noreferrer"></a>
          <div className={`${styles.showcaseblock2} ${font.className}`} style={{backgroundImage: `url(${showcaseimg2.src})`}}></div>
        </div>
        <div className={styles.showcaseouter2}>
          <div className={styles.showcaseinner}>
              <a className={styles.showcaseblock3} style={{backgroundImage: `url(${showcaseimg3.src})`}} href="https://initial-mern.vercel.app/" target="_blank" rel="noopener noreferrer"></a>
              <a className={styles.showcaseblock4} style={{backgroundImage: `url(${showcaseimg4.src})`}} href="https://www.introme.me/" target="_blank" rel="noopener noreferrer"></a>
          </div>
